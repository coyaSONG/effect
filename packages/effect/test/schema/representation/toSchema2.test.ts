import { Redacted, Schema, SchemaRepresentation2 as SchemaRepresentation } from "effect"
import { describe, it } from "vitest"
import { deepStrictEqual, strictEqual } from "../../utils/assert.ts"
import { builtInRevivers } from "./v2Parity.ts"

describe("SchemaRepresentation2 revival parity", () => {
  function assertToSchemaRoundtrip(input: {
    ...
    const revived = SchemaRepresentation.fromJson(json, { revivers: builtInRevivers })
    ...
    const codeDocument = SchemaRepresentation.toCodeDocument({
      representations: [roundtrip.representation],
  ...
  describe("toSchemaDefaultReviver", () => {
    ...
    it("Redacted options", () => {
      ...
      const roundtrip = SchemaRepresentation.fromJson(SchemaRepresentation.toJson(document), {
