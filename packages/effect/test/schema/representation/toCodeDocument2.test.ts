...
describe("toCodeDocument2 parity", () => {
  type Expected = {
  ...
  const makeCode = (runtime: string, Type: string): SchemaRepresentation.Code => ({ runtime, Type })

  describe("Declaration", () => {
    it("declaration without a generation annotation", () => {
      throws(
